    ...
    <div class="px-4 sm:px-6 lg:px-8 mt-20">
        <div class="mt-8 flow-root">
            <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8 bg-white p-5">
                    <table class="min-w-full divide-y divide-gray-300">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="relative py-3.5 pl-3 pr-4 sm:pr-0 text-gray-900">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr v-for="service in services" :key="service.id">
                                ...
                                <td @click="
                                    ...
                                    <p class="border p-1 text-center rounded-md" :class="{
